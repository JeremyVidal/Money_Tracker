<?PHP
    ...
    function display_form(){
            ...
            <section id="contact_edit">
                <div id="contact_edit_image"><img src="media/companies/<? echo $data['contactName']?>.png"></div>
                <div id="contact_edit_name"><? echo $data['contactName']?></div><br>
                ...
                <form id="contact_edit_form" name="contact_edit_form" action="editcontact.php" method="POST">
                        <input type="hidden" name="contactupdateID" value="<? echo $data['contactID']?>">
                        <table>
                            <tr>
                                <td>Type</td>
                                <td><select id="contactupdatetype" name="contactupdatetype">
                                    <option value="" <? if ($contactType == "") {echo "selected";};?>></option>
                                    <option value="Phone" <? if ($contactType == "Phone") {echo "selected";};?>>Phone</option>
                                    <option value="Text" <? if ($contactType == "Text") {echo "selected";};?>>Text</option>
                                    <option value="Email" <? if ($contactType == "Email") {echo "selected";};?>>Email</option>
                                    <option value="In Person" <? if ($contactType == "In Person") {echo "selected";};?>>In Person</option>
                                </select>
                                </td>
                                <td>Result</td>
                                <td><select id="contactupdateresult" name="contactupdateresult">
                                    <option value="Contacted" <? if ($contactResult == "Contacted") {echo "selected";};?>>Contacted</option>
                                    <option value="Voicemail" <? if ($contactResult == "Voicemail") {echo "selected";};?>>Voicemail</option>
                                    <option value="Incoming" <? if ($contactResult == "Incoming") {echo "selected";};?>>Incoming</option>
                                    <option value="Future" <? if ($contactResult == "Future") {echo "selected";};?>>Future</option>
                                </select>
                                </td>
                            </tr>
                            <tr>
