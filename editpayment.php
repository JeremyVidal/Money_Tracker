...
function display_form(){
	...
	<section id="payment_edit">
		<div id="payment_edit_image"><img src="media/<?PHP echo $data['paymentType']; ?>.png"></div>
		<div id="payment_edit_type"><?PHP echo $data['paymentName']; ?></div><br>
		...
		<form id="payment_edit_form" name="payment_update" action="editpayment.php" method="POST">
			...
			<table>
				<tr>
					<td>Date</td><td><input type="date" name="editdate" value="<?PHP echo $data['paymentDate']; ?>"></td>
					<td>Time</td><td><input type="time" name="edittime" value="<?PHP echo $data['paymentTime']; ?>"></td>
				</tr>
				<tr>
				<td>Description</td>
					<td colspan="3"><textarea id="editnotes" name="editnotes" rows="2" cols="40" max-length="200" value=""><?PHP echo $data['paymentDescription']; ?></textarea></td>
				</tr>
				<tr>
					<td>Amount</td><td><input type="number" name="editamount" size="10" min="0.00" step="0.01" value="<?PHP echo $data['paymentPaidAmount']; ?>"></td>
					<td>Type</td>
